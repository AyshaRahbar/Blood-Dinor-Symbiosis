<html><body>
        ...
        try {
            ...
            String Apos=request.getParameter("Apos");
              ...
              String sql="update hospitaldetails set Opos='"+Opos+"',Oneg='"+Oneg+"',Apos='"+Apos+"',Aneg='"+Aneg+"',ABpos='"+ABpos+"',ABneg='"+ABneg+"',Bpos='"+Bpos+"',Bneg='"+Bneg+"' where uname='"+s+"'";
              %><%= sql %><%
              int i= st.executeUpdate(sql);
              %><jsp:forward page="hospitalfrontend.jsp" /><%
