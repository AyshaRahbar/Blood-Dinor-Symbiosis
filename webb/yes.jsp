<%-- 
    Document   : yes
    Created on : Mar 5, 2009, 4:05:33 PM
...
<html>
	...
	<div id="header">
        ...
        String s=(String)session.getAttribute("hname");
        ...
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/bds", "root", "mysql");
           ...
           int i=st.executeUpdate("delete from hospitaldetails where hName='"+s+"'");
           int j=st.executeUpdate("delete from user where uname='"+s1+"'");
           

           out.println("hospital has been deleted");
     %>
   <%
        }catch(Exception e){
            e.printStackTrace();
