...
<html>
    <head>
        ...
        <title>hospital front-end</title>
...
<div id="container">
 ...
 <div id="content">
     ...
     ResultSet r = st.executeQuery("select * from hospitaldetails");%>
     <form name="hdisplay" >
